                ...
                <header className={styles.header}>
                    ...
                    {profile && (
                        <div className={styles.profileBadge}>
                            <span className={styles.profileBadgeAge}>
                                {profile.age} yrs
                            </span>
                    ...
                    {recentWorkouts.length === 0 ? (
                        ...
                        <div className={styles.recentWorkoutList}>
                            {recentWorkouts.map((workout) => {
                                ...
                                const unit = profile
                                    ? distanceUnit(workout.workoutDiscipline, profile.metric)
                                    : "";
                                    ...
                                    >
                                        ...
                                        <div className={styles.recentWorkoutInfo}>
                                            ...
                                            <div className={styles.recentWorkoutStats}>
                                                ...
                                                {workout.workoutDistance} {unit}
                                            </div>

                                            {workout.workoutNotes && (
                                                <div className={styles.recentWorkoutNotes}>
                                                    {workout.workoutNotes}
                                                </div>
                                            )}
                                        </div>
                    ...
                    <div className={styles.disciplineGrid}>
                        {DISCIPLINES.map((d) => (
                            <div key={d.key} className={styles.disciplineCard}>
                                ...
                                <span className={styles.disciplineComingSoon}>
                                    Coming soon
                                </span>
                            </div>
                        ))}
                    ...
                    <div className={styles.panelGrid}>
                        <div className={styles.panel}>
                            ...
                            <p className={styles.panelBody}>
                                Generate a personalized week-by-week triathlon plan
                                based on your goal race and current fitness.
                            </p>
                        ...
                        <div className={styles.panel}>
                            ...
                            <p className={styles.panelBody}>
                                Record your swim, bike, and run sessions with distance,
                                duration, and notes.
                            </p>
                        ...
                        <div className={styles.panel}>
                            ...
                            <p className={styles.panelBody}>
                                Track volume trends across disciplines and see how your
                                training load builds over time.
                            </p>
                            <button className={styles.panelButton} disabled>
                                View Analytics
                            </button>
